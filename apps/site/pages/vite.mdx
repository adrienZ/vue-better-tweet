...
- [localhost:5173/tweet/2014481742875521242](http://localhost:5173/tweet/2014481742875521242) renders dynamic tweets with SWR. `Tweet` already uses SWR and this page shows how to implement it manually.
