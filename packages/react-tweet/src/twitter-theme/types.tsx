...
export type TwitterComponents = {
  TweetNotFound?: typeof import('./tweet-not-found.jsx').TweetNotFound
  AvatarImg?: typeof import('./avatar-img.jsx').AvatarImg
  MediaImg?: typeof import('./media-img.jsx').MediaImg
}
